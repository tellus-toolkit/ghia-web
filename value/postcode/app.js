$(document).ready(function () {
    ...
    $("#validate-postcode").click(function (event) {
        ...
        $.get(encodeURI("https://api.postcodes.io/postcodes/" + postcode + "/validate"))
            .done(function (data) {
                displayJsonResult($result, data);
                if (data['result'] === true) {
                    //alert('The postcode is valid');
                    document.getElementById("validate-postcode-result").innerHTML = "The postcode " + (postcode) +
                        " is valid.";
                } else if (data['result'] === false) {
                    //alert('The postcode is not valid');
                    document.getElementById("validate-postcode-result").innerHTML = (postcode) +
                        " is not valid according to the Post Office's database.";
                }
            })
            .fail(function (error) {
                displayJsonResult($result, error.responseJSON);
                //alert('Invalid entry');
                document.getElementById("validate-postcode-result").innerHTML = "Please enter your postcode.";
            });
    });
